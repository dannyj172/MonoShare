      ...
      <div className="relative flex flex-col w-md h-fit rounded-xl m-auto py-8 px-8 z-10 bg-white/3 border-gray-400/20 border">
        ...
        <form action="" method="post">
          <div className="flex flex-col noto-sans mt-6 gap-1">
            ...
            <div className="group flex gap-2 items-center border border-gray-400/20 px-3 rounded-xl duration-200 focus-within:border-(--main-light-blue) focus-within:outline-3 focus-within:outline-cyan-600/30 focus-within:bg-blue-300/10">
              <svg
